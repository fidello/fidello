...
public class PontoFacade extends AbstractFacade implements Serializable {
	...
	public Ponto cadastrarPontos(Ponto ponto, Campanha campanha)
			throws Exception {
		...
		try {
			...
			Date validade = CalcularDataValidade(campanha.getValidadeTipo(),
					campanha.getValidade());
	...
	public Date CalcularDataValidade(Integer validadeTipo, Integer validade)
			throws Exception {
	...
	public void CalcularPontosValor(Campanha campanha, Ponto ponto)
			throws Exception {
	...
	public Collection<Ponto> detalharPontosPorData(Pessoa pessoa,
	...
	public Collection<Ponto> detalharPontosPorPessoa(Integer idPessoa)
			throws Exception {
		...
		try {
			...
			return pontoDAO.detalharPontosPorPessoa(pessoa);
